...
[![VS Marketplace Version](https://img.shields.io/visual-studio-marketplace/v/hightemp.php-lsp?label=marketplace)](https://marketplace.visualstudio.com/items?itemName=hightemp.php-lsp)
[![VS Marketplace Downloads](https://img.shields.io/visual-studio-marketplace/d/hightemp.php-lsp?label=marketplace%20downloads)](https://marketplace.visualstudio.com/items?itemName=hightemp.php-lsp)
[![VS Marketplace Installs](https://img.shields.io/visual-studio-marketplace/i/hightemp.php-lsp?label=installs)](https://marketplace.visualstudio.com/items?itemName=hightemp.php-lsp)
[![VS Marketplace Rating](https://img.shields.io/visual-studio-marketplace/r/hightemp.php-lsp?label=rating)](https://marketplace.visualstudio.com/items?itemName=hightemp.php-lsp)
