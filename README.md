...
[![VS Marketplace Version](https://img.shields.io/visual-studio-marketplace/v/hightemp.ht-php-lsp?label=marketplace)](https://marketplace.visualstudio.com/items?itemName=hightemp.ht-php-lsp)
