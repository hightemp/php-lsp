...
6. Не забывай обновлять документацию, но не надо нести в документацию все правки из задач, только новые фичи
7. Перед тем как сдать задачу с исправлениями кода запусти субагента Verifier чтобы он все проверил. Исправь все что он напишет и запускай его снова пока все не будет исправлено.